  ...
  return (
    <div className="gc-app">
      <header className="gc-topbar">
        <NavLink to="/overview" className="gc-logo">
          <Logo size={24} />
        </NavLink>
        <nav className="gc-nav">
          ...
          <NavLink to="/overview" className="gc-nav-link">
            Overview
          </NavLink>
  ...
  return (
    <StoreProvider>
      <Routes>
        ...
        {/* The website list lives inside the overview now. Old links still work. */}
        <Route path="/websites" element={<Navigate to="/overview" replace />} />
